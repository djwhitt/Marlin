...
#define STRING_CONFIG_H_AUTHOR "djwhitt" //Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,2015.748,760 * 1.128}  // default steps per unit for ultimaker
